...
test('Product tree collapsible vendor visibility', async ({ page }) => {
  ...
  await page.getByRole('heading', { name: ' Product tree' }).click()
  await page.getByRole('heading', { name: ' Branches' }).click()
  await expect(page.getByText('vendor CSAF Tools product_name CVRF-CSAF-Converter product_version 1.0.0-alpha C')).toBeVisible()
});
...
test('Product tree collapsible product name visibility', async ({ page }) => {
  ...
  await page.getByRole('heading', { name: ' Product tree' }).click()
  await page.getByRole('heading', { name: ' Branches' }).click()
  await expect(page.getByText('product_name CVRF-CSAF-Converter product_version 1.0.0-alpha CSAF Tools CVRF-CSA')).toBeVisible()
});
...
test('Product tree collapsible product version 2 collapsible visibility', async ({ page }) => {
  ...
  await page.getByRole('heading', { name: ' Product tree' }).click()
  await page.getByRole('heading', { name: ' Branches' }).click()
  await expect(page.getByRole('heading', { name: ' CSAF Tools CVRF-CSAF-Converter 1.0.0-dev1' })).toBeVisible()
});
...
test('Product tree collapsible product version 2 collapsible Product ID visibility', async ({ page }) => {
  await page.goto('/');
  await page.locator('input[type="file"]').click();
  await page.locator('input[type="file"]').setInputFiles('./docs/bsi-2022-0001.json');
...
test('Product tree collapsible product version 2 collapsible Product ID entry visibility', async ({ page }) => {
  await page.goto('/');
  await page.locator('input[type="file"]').click();
  await page.locator('input[type="file"]').setInputFiles('./docs/bsi-2022-0001.json');
  ...
  await page.getByRole('heading', { name: ' Branches' }).click()
  await page.getByRole('heading', { name: ' CSAF Tools CVRF-CSAF-Converter 1.0.0-dev1' }).click()
  await expect(page.getByRole('cell', { name: 'CSAF Tools CVRF-CSAF-Converter 1.0.0-dev1' })).toBeVisible()
});

test('Product tree collapsible product version 2 collapsible Product version helper visibility', async ({ page }) => {
  await page.goto('/');
  await page.locator('input[type="file"]').click();
  await page.locator('input[type="file"]').setInputFiles('./docs/bsi-2022-0001.json');
...
test('Product tree collapsible product version 2 collapsible Product version helper cpe visibility', async ({ page }) => {
  await page.goto('/');
  await page.locator('input[type="file"]').click();
  await page.locator('input[type="file"]').setInputFiles('./docs/bsi-2022-0001.json');
...
test('Product tree collapsible product version 2 collapsible Product version helper cpe value visibility', async ({ page }) => {
  await page.goto('/');
  await page.locator('input[type="file"]').click();
  await page.locator('input[type="file"]').setInputFiles('./docs/bsi-2022-0001.json');
